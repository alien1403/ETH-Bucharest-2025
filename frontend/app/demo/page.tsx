			...
			<main className='container mx-auto px-4 py-8 md:px-6'>
					...
					<div className='flex items-start gap-3'>
						...
						<div>
							...
							<p className='mt-1 text-slate-300'>
								This is a demonstration of the confidential voting process.
								Follow the steps below to experience how secure voting works.
							</p>
					...
					<div className='mb-8'>
						<div className='flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between'>
							<h1 className='text-2xl font-bold sm:text-3xl text-white'>
								Demo Proposal: New Feature Implementation
							</h1>
						...
						<div className='mt-4 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between'>
							<p className='text-slate-400'>
								Should we implement the new feature set in the next release?
								This is a demonstration proposal to showcase the voting
								interface.
							</p>
									...
									<TooltipProvider>
										<Tooltip open={showTooltip}>
											...
											<TooltipContent side='right' className='max-w-xs'>
												<p>
													Select an option to vote. Your choice will be
													encrypted.
												</p>
											</TooltipContent>
										</Tooltip>
							...
							{voteState === 'post-vote' && (
								<div className='flex flex-col items-center justify-center py-8 text-center'>
									...
									<p className='mt-2 text-slate-400'>
										Your vote has been encrypted and recorded. For this demo,
										results will be revealed in a few seconds.
									</p>
							...
							{voteState === 'results-hidden' && (
								<div className='space-y-6'>
									...
									<div className='flex items-center justify-center gap-2 rounded-lg border border-dashed border-slate-700 bg-slate-800/30 p-4 text-center text-sm text-slate-400'>
										<Lock className='h-4 w-4' />
										<span>
											Results will be revealed in a few seconds (demo only)
										</span>
									</div>
								</div>
							)}
							...
							{voteState === 'results-revealed' && (
								<div className='space-y-6'>
									...
									<div className='flex items-center justify-center gap-2 rounded-lg border border-green-500/30 bg-green-500/5 p-4 text-center text-sm text-green-400'>
										...
										<span>
											{selectedOption === 'yes' &&
											progressValues.yes > progressValues.no
												? 'Proposal approved! Your vote helped pass this proposal.'
												: selectedOption === 'no' &&
												  progressValues.no > progressValues.yes
						...
						>
							...
							<CollapsibleContent className='px-4 pb-4'>
								<div className='space-y-4 text-sm text-slate-400'>
									<p>
										This demo simulates the confidential voting process. Here's
									...
									<div className='space-y-2'>
										...
										<p>
											When you select an option and submit your vote, in a real
											implementation, your vote would be encrypted on your
											device using a public key. This ensures that no one, not
											even the system administrators, can see your individual
											vote.
										</p>
									</div>
									...
									<div className='space-y-2'>
										...
										<p>
											After your encrypted vote is submitted, you receive a
											confirmation that your vote was recorded. In a real
											implementation, you would also receive a cryptographic
											receipt that you could use to verify your vote was
									...
									<div className='space-y-2'>
										...
										<p>
											While voting is in progress, the results remain encrypted.
											Using fully homomorphic encryption (FHE), votes can be
											tallied without ever decrypting individual votes,
											maintaining privacy throughout the process. This
											revolutionary technology prevents corruption by
											eliminating any opportunity for vote manipulation, making
											it ideal for ensuring fair elections worldwide.
										</p>
									</div>
									...
									<div className='space-y-2'>
										...
										<p>
											Once voting ends, the final tally is revealed. In a real
											implementation, this would require a threshold of
											authorized parties to cooperate in decrypting the final
											tally, ensuring that no single entity can manipulate the
											results.
										</p>
									</div>
									...
									<div className='mt-4 rounded-lg border border-purple-500/30 bg-purple-500/5 p-3'>
										<p className='text-purple-400'>
											<strong>Note:</strong> This is a simplified demonstration.
											In a real implementation, fully homomorphic encryption
											(FHE) and additional cryptographic techniques would be
											used to ensure the integrity and confidentiality of the
											voting process, creating a truly fair system that prevents
				...
				<div className='mx-auto mt-16 max-w-3xl text-center'>
					...
					<p className='mt-4 text-slate-400'>
						Explore our detailed documentation to understand how confidential
						voting works and the technology behind it.
					</p>
			...
			<footer className='border-t border-slate-800 bg-slate-950 mt-16'>
				<div className='container mx-auto px-4 py-8 md:px-6'>
					...
					<div className='flex flex-col items-center justify-between gap-4 md:flex-row'>
						...
						<p className='text-center text-sm text-slate-400'>
							This is a demo project. No actual voting functionality is
							implemented.
						</p>
					</div>
				</div>
